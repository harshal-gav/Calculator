...
export default function BandwidthCalculator() {
  ...
  const calculateTime = () => {
    ...
    const sizeInBits =
      size * (fileUnits.find((u) => u.id === fileUnit)?.multiplier || 1);
    const speedInBitsPerSec =
      spd * (speedUnits.find((u) => u.id === speedUnit)?.multiplier || 1);
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8 bg-white rounded-xl shadow-lg border border-gray-100">
      ...
      <p className="mb-8 text-gray-600 text-lg">
        Calculate EXACTLY how long it will take to download or upload a file
        ...
        <div className="bg-indigo-50 p-6 rounded-xl border border-indigo-100 space-y-6">
          ...
          <div>
            ...
            <p className="text-[10px] text-gray-500 mt-2 pl-1">
              Note: ISPs advertise speed in Megabits (Mbps), not Megabytes
              (MB/s).
            </p>
          </div>
        </div>
          ...
          {result.isValid ? (
            <div className="p-8 h-full flex flex-col justify-center bg-gradient-to-br from-indigo-600 to-indigo-800 text-white relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h3 className="text-indigo-200 font-bold uppercase tracking-widest text-xs mb-4">
                ...
                <div className="text-indigo-300 font-medium text-sm mt-4">
                  {result.seconds > 60 &&
                    `(${result.seconds.toFixed(1)} total seconds)`}
                </div>
              </div>
            </div>
          ) : (
      ...
      <div className="mt-8 text-left">
        <CalculatorSEO
          ...
          whatIsIt={
            <p>
              The <strong>Bandwidth Calculator</strong> accurately estimates how
              long it will take to download or upload a digital file across a
              network. It bridges the mathematical gap between binary file sizes
              (Megabytes, Gigabytes) and network transmission speeds (Megabits,
              Gigabits) to provide precise time durations.
            </p>
          }
          formula={
          <>
          ...
          example={
            <>
              <p>
                Let's calculate the download time for a massive 50 GB video game
                on a standard 500 Mbps fiber connection.
              </p>
              <ul className="list-disc pl-6 space-y-2 mt-4 text-gray-700">
                <li>
                  <strong>The Input:</strong> 50 Gigabytes (file) at 500
                  Megabits per second (speed).
                </li>
                <li>
                  <strong>The Conversion:</strong> 50 GB equals 400 Gigabits.
                  (Since 1 Byte = 8 bits, 50 * 8 = 400).
                </li>
                <li>
                  <strong>The Division:</strong> 400,000 Megabits / 500 Mbps =
                  800 seconds.
                </li>
                <li>
                  <strong>Result:</strong> 800 seconds equals exactly{" "}
                  <strong>13 minutes and 20 seconds</strong>.
                </li>
              </ul>
            </>
          }
          useCases={
            <ul className="list-disc pl-6 space-y-4 text-gray-700">
              <li>
                <strong>Cloud Backup Management:</strong> IT professionals use
                this tool to determine scheduling windows. If a daily database
                backup is 2 Terabytes, they need to verify it can complete
                uploading over a 1 Gbps connection before business hours start.
              </li>
              <li>
                <strong>Gaming and Media:</strong> Consumers wanting to know if
                a heavy 100GB 4K movie or next-gen game patch will finish
                downloading before their friends log on.
              </li>
              <li>
                <strong>ISP Verification:</strong> Validating whether paying
                double for a "Gigabit" connection practically benefits you
                compared to a 300 Mbps connection for the types of files you
                actually transfer.
              </li>
            </ul>
          }
