        ...
        <div className="max-w-4xl mx-auto p-4 md:p-8 bg-zinc-50 rounded-2xl shadow-xl border border-zinc-200">
            ...
            <div className="mt-8">
                <CalculatorSEO
                    ...
                    whatIsIt={
                        <>
                            <p>A <strong>Quadratic Formula Calculator</strong> is a specialized algebraic tool designed to solve second-degree polynomial equations of the form <strong>ax² + bx + c = 0</strong>.</p>
                            <p>By inputting the coefficients (a, b, and c), the calculator instantly applies the quadratic equation to determine the exact roots (x-intercepts) of the parabola. It intelligently detects and calculates both real roots and complex (imaginary) roots.</p>
                        </>
                    }
                    formula={
                        <>
                            ...
                            <p className="mt-4">The expression inside the square root, <strong>(b² - 4ac)</strong>, is called the <strong>Discriminant (Δ)</strong>. It determines the nature of the roots:</p>
                            <ul className="list-disc pl-6 space-y-2 mt-4">
                                <li><strong>Δ &gt; 0:</strong> Two distinct real roots (parabola crosses the x-axis twice).</li>
                                <li><strong>Δ = 0:</strong> One real root / repeated root (parabola touches the x-axis exactly once).</li>
                                <li><strong>Δ &lt; 0:</strong> Two complex conjugate roots (parabola never touches the x-axis).</li>
                            </ul>
                        </>
                    }
                    example={
                        <>
                            <p>Let's solve the equation: <strong>2x² - 4x - 6 = 0</strong></p>
                            <ul className="list-disc pl-6 space-y-2 mt-4 font-mono text-sm border-l-2 border-emerald-500 pl-4 py-2 bg-emerald-50/50">
                                <li>Here, <strong>a = 2</strong>, <strong>b = -4</strong>, and <strong>c = -6</strong>.</li>
                                <li className="pt-2 text-zinc-600 border-t border-emerald-200 mt-2">Calculate Discriminant: (-4)² - 4(2)(-6) = 16 + 48 = <strong>64</strong></li>
                                <li>x = [ -(-4) ± √64 ] / 2(2)</li>
                                <li>x = [ 4 ± 8 ] / 4</li>
                                <li className="pt-2 text-zinc-600 border-t border-emerald-200 mt-2"><strong>Root 1:</strong> (4 + 8) / 4 = 12 / 4 = <strong>3</strong></li>
                                <li><strong>Root 2:</strong> (4 - 8) / 4 = -4 / 4 = <strong>-1</strong></li>
                            </ul>
                            <p className="mt-4 text-emerald-700 font-bold border-t border-emerald-100 pt-4 text-center text-lg">The roots are x = 3 and x = -1.</p>
                        </>
                    }
                    useCases={
                        <ul className="list-disc pl-6 space-y-4">
                            <li><strong>Algebra & Calculus Homework:</strong> Instantly check answers to complex quadratic equations without manual calculation.</li>
                            <li><strong>Physics Calculations:</strong> Highly useful in kinematics to calculate exactly when a projectile will hit the ground (where height = 0).</li>
                            <li><strong>Engineering Optimization:</strong> Finding maximum or minimum values (optimization) in systems described by parabolic curves.</li>
                        </ul>
                    }
                    faqs={[
                        {
                            question: "What happens if variable 'a' is zero?",
                            answer: "If 'a' is zero, the equation is no longer quadratic; it becomes a linear equation (bx + c = 0). Our calculator will detect this and solve the linear equation for you (x = -c/b)."
                        },
                        {
                            question: "Why do some equations output an 'i'?",
                            answer: "The 'i' represents an imaginary number (the square root of -1). This occurs when the discriminant (b² - 4ac) is negative. Because you cannot take the square root of a negative number in real mathematics, the result consists of two complex conjugate roots."
                        }
                    ]}
                    relatedCalculators={[
                        { name: "Order of Operations Calculator", path: "/order-of-operations-calculator", desc: "Evaluate mathematical expressions step-by-step." },
                        { name: "Cubic Equation Calculator", path: "/cubic-equation-calculator", desc: "Solve polynomials up to the third degree." },
                        { name: "Projectile Motion Calculator", path: "/projectile-motion-calculator", desc: "Calculate flight time and distance using physics and quadratics." }
                    ]}
                />
            </div>
        </div>
