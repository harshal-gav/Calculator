...
import mmmSeoData from "@/data/seo-content/official/mean-median-mode-calculator.json";
...
export default function MeanMedianModeCalculator() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8 bg-white rounded-xl shadow-lg border border-gray-100">
      ...
      <div className="mt-8">
        <CalculatorSEO
          title={mmmSeoData.title}
          whatIsIt={mmmSeoData.whatIsIt}
          formula={mmmSeoData.formula}
          example={mmmSeoData.example}
          useCases={mmmSeoData.useCases}
          faqs={mmmSeoData.faqs}
          deepDive={mmmSeoData.deepDive}
          glossary={mmmSeoData.glossary}
          relatedCalculators={[
            {
