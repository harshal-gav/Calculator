    ...
    <div className="max-w-5xl mx-auto p-4 md:p-8 bg-white rounded-3xl shadow-xl border border-purple-50">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-purple-50 pb-6 mb-8 gap-4">
        <div>
          ...
          <p className="text-slate-500 font-medium mt-1 text-lg">Calculate the mean, median, and mode of a dataset.</p>
        </div>
      ...
      <CalculatorSEO
        ...
        whatIsIt={
          <p>
            The <strong>Average Calculator</strong> is a tool designed to calculate the mean, median, and mode of a dataset.
          </p>
        }
        formula={
          <>
            ...
            <p className="text-sm text-slate-500 text-center">
              Arithmetic Mean: divide sum of values by the count.
            </p>
          </>
        }
        example={
        ...
        faqs={[
          {
            question: "How accurate is the Average Calculator?",
