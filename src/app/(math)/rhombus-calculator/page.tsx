...
import rhombusSeoData from "@/data/seo-content/official/rhombus-calculator.json";
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8 bg-white rounded-xl shadow-lg border border-gray-100">
      ...
      <div className="mt-8 text-left">
        <CalculatorSEO
          title={rhombusSeoData.title}
          whatIsIt={rhombusSeoData.whatIsIt}
          formula={rhombusSeoData.formula}
          example={rhombusSeoData.example}
          useCases={rhombusSeoData.useCases}
          faqs={rhombusSeoData.faqs}
          deepDive={rhombusSeoData.deepDive}
          glossary={rhombusSeoData.glossary}
          relatedCalculators={[
            {
