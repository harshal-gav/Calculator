...
import primeNumberSeoData from "@/data/seo-content/official/prime-number-calculator.json";
...
export default function PrimeNumberCalculator() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8 bg-white rounded-xl shadow-lg border border-gray-100 font-sans">
      ...
      <CalculatorSEO
        title={primeNumberSeoData.title}
        whatIsIt={primeNumberSeoData.whatIsIt}
        formula={primeNumberSeoData.formula}
        example={primeNumberSeoData.example}
        useCases={primeNumberSeoData.useCases}
        faqs={primeNumberSeoData.faqs}
        deepDive={primeNumberSeoData.deepDive}
        glossary={primeNumberSeoData.glossary}
        relatedCalculators={[
          {
