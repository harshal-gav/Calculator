    ...
    return (
        <div className="max-w-4xl mx-auto p-4 md:p-8 bg-white rounded-xl shadow-lg border border-gray-100">
            ...
            <CalculatorSEO
                ...
                whatIsIt={
                    <>
                        <p>Our <strong>Volume Calculator</strong> is an essential geometry tool that instantly computes the three-dimensional space enclosed by common shapes like cubes, cylinders, cones, spheres, and rectangular prisms.</p>
                        <p>While "area" measures the flat, 2D surface of an object, "volume" measures its true 3D capacity. Think of volume as exactly how much water it would take to completely fill up the shape.</p>
                    </>
                }
                formula={
                    <>
                        <p>Every three-dimensional shape requires a unique mathematical formula to determine its exact volume. Here are the core formulas this calculator uses natively:</p>
                        <div className="bg-white p-4 rounded-lg font-mono text-center text-lg shadow-sm my-4 overflow-x-auto space-y-4 text-pink-900 border border-pink-100">
                            <p><strong>Cube:</strong> Volume = edge³</p>
                            <p><strong>Rectangular Prism:</strong> Volume = length × width × height</p>
                            <p><strong>Cylinder:</strong> Volume = πr²h</p>
                            <p><strong>Sphere:</strong> Volume = ⁴⁄₃πr³</p>
                            <p><strong>Cone:</strong> Volume = ¹⁄₃πr²h</p>
                        </div>
                        <p className="mt-4">Where <strong>r</strong> represents the radius (half the diameter) and <strong>h</strong> represents the total height of the object.</p>
                    </>
                }
                example={
                    <>
                        <p>Let's calculate the volume of a standard cylindrical soda can to see how much liquid it can hold.</p>
                        <ul className="list-disc pl-6 space-y-2 mt-4">
                            <li><strong>Step 1 (Identify Measurements):</strong> The radius of the base is roughly <strong>1.2 inches</strong> and the height is <strong>4.8 inches</strong>.</li>
                            <li><strong>Step 2 (The Formula):</strong> V = π * r² * h</li>
                            <li><strong>Step 3 (Square the radius):</strong> 1.2² = 1.44</li>
                            <li><strong>Step 4 (Multiply):</strong> 3.14159 * 1.44 * 4.8 = <strong>21.71 cubic inches</strong>.</li>
                        </ul>
                    </>
                }
                useCases={
                    <ul className="list-disc pl-6 space-y-4">
                        <li><strong>Shipping & Packaging:</strong> Calculating the total cubic volume of a rectangular box to determine the exact shipping tier or cargo space required on a freight truck.</li>
                        <li><strong>Construction & Landscaping:</strong> Determining exactly how many cubic yards of concrete or soil you need to order to fill a cylindrical hole or a rectangular garden bed.</li>
                        <li><strong>Aquariums:</strong> Finding the absolute water capacity of a fish tank to ensure you purchase the correct size filtration system and the right number of fish.</li>
                        <li><strong>Baking:</strong> Comparing the volume of a 9-inch round cake pan to a rectangular pan to see if the same amount of batter will fit without overflowing.</li>
                    </ul>
                }
                faqs={[
                    {
                        question: "What is the difference between Area and Volume?",
                        answer: "Area measures the two-dimensional surface space of a flat object (like the floor of a room), measured in square units (like square feet). Volume measures the total three-dimensional space an object occupies (the entire room from floor to ceiling), measured in cubic units."
                    },
                    {
                        question: "Why does the cone formula have a 1/3 in it?",
                        answer: "Geometrically, if you have a cylinder and a cone that both share the exact same base radius and the exact same height, the cone will always hold exactly one-third (1/3) of the volume of the cylinder. It's a mathematically perfect relationship."
                    },
                    {
                        question: "What unit of measurement should I use?",
                        answer: "You can use any unit—inches, centimeters, feet, or meters. As long as you use the exact same unit for every single input (don't mix feet and inches), the resulting volume will simply be measured in that unit 'cubed' (e.g., cubic inches, cubic meters)."
                    }
                ]}
                relatedCalculators={[
