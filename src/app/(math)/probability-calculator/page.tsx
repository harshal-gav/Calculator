...
import probabilitySeoData from "@/data/seo-content/official/probability-calculator.json";
...
export default function ProbabilityCalculator() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8 bg-white rounded-xl shadow-lg border border-gray-100">
      ...
      <div className="mt-8">
        <CalculatorSEO
          title={probabilitySeoData.title}
          whatIsIt={probabilitySeoData.whatIsIt}
          formula={probabilitySeoData.formula}
          example={probabilitySeoData.example}
          useCases={probabilitySeoData.useCases}
          faqs={probabilitySeoData.faqs}
          deepDive={probabilitySeoData.deepDive}
          glossary={probabilitySeoData.glossary}
          relatedCalculators={[
            {
