...
import rngSeoData from "@/data/seo-content/official/random-number-generator.json";
...
export default function RandomNumberGenerator() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8 bg-white rounded-xl shadow-lg border border-gray-100">
      ...
      <div className="mt-8">
        <CalculatorSEO
          title={rngSeoData.title}
          whatIsIt={rngSeoData.whatIsIt}
          formula={rngSeoData.formula}
          example={rngSeoData.example}
          useCases={rngSeoData.useCases}
          faqs={rngSeoData.faqs}
          deepDive={rngSeoData.deepDive}
          glossary={rngSeoData.glossary}
          relatedCalculators={[
            {
