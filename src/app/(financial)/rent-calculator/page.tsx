...
import rentSeoData from "@/data/seo-content/official/rent-calculator.json";
...
export default function RentCalculator() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8 bg-white rounded-xl shadow-lg border border-gray-100">
      ...
      <div className="mt-8">
        <CalculatorSEO
          title={rentSeoData.title}
          whatIsIt={rentSeoData.whatIsIt}
          formula={rentSeoData.formula}
          example={rentSeoData.example}
          useCases={rentSeoData.useCases}
          faqs={rentSeoData.faqs}
          deepDive={rentSeoData.deepDive}
          glossary={rentSeoData.glossary}
          relatedCalculators={[
            {
