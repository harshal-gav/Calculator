...
import irrSeoData from "@/data/seo-content/official/irr-calculator.json";
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8 bg-white rounded-xl shadow-lg border border-gray-100">
      ...
      <p className="mb-8 text-gray-600 text-lg">
        Calculate the Internal Rate of Return (IRR) to find the annualized
        percent growth rate of an investment based on periodic cash flows.
      </p>
          ...
          <div className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full rounded border-gray-300 p-3 shadow-sm focus:ring-indigo-500 border"
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-2">
                Enter the expected cash received each year, separated by commas.
              </p>
            </div>
          </div>
        ...
        <div className="bg-indigo-50 rounded-xl p-8 border border-indigo-200 shadow-inner flex flex-col justify-center">
          {result !== null ? (
            <div className="text-center w-full">
              <span className="block text-xs font-bold text-indigo-700 uppercase mb-2 tracking-widest">
            ...
            <div className="text-center text-indigo-800 opacity-60 font-medium">
              Input your investment sequence to see the true annualized
              performance percent.
            </div>
          )}
        </div>
      ...
      <CalculatorSEO
        title={irrSeoData.title}
        whatIsIt={irrSeoData.whatIsIt}
        formula={irrSeoData.formula}
        example={irrSeoData.example}
        useCases={irrSeoData.useCases}
        faqs={irrSeoData.faqs}
        deepDive={irrSeoData.deepDive}
        glossary={irrSeoData.glossary}
        relatedCalculators={[
          {
            name: "ROI",
            path: "/roi-calculator/",
