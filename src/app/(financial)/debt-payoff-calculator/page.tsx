...
export default function DebtPayoffCalculator() {
  ...
  const calculatePayoff = () => {
    ...
    if (payment <= minimumInterestPayment && rate > 0) {
      setResult({
        ...
        isValid: false,
        message:
          "Your monthly payment doesn't even cover the interest. The debt will grow forever.",
      });
      return;
    }
    ...
    if (months >= 1200) {
      setResult({
        ...
        isValid: false,
        message:
          "This will take over 100 years to pay off. Please increase your monthly payment.",
      });
      return;
    }
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8 bg-white rounded-xl shadow-lg border border-gray-100">
      <h1 className="text-4xl font-extrabold mb-4 text-red-800 border-b pb-4">
        Debt Payoff Calculator
      </h1>
      <p className="mb-8 text-gray-600 text-lg">
        Discover how long it will take to become debt-free and exactly how much
        interest you'll pay the bank.
      </p>
        ...
        <div className="bg-red-50 p-6 rounded-xl border border-red-100 space-y-6">
          <div>
            ...
            <div className="relative">
              <span className="absolute left-4 top-1/2 -translate-y-1/2 text-red-600 font-bold text-lg">
                $
              </span>
              <input
                type="number"
          ...
          {result.isValid ? (
            <div className="w-full flex flex-col h-full">
              <div className="p-8 pb-6 text-center bg-red-700 border-b border-red-800 text-white">
                <h3 className="text-red-200 font-bold uppercase tracking-widest text-[11px] mb-2">
                  Time Until Completely Debt Free
                </h3>
                <div className="text-6xl font-black drop-shadow-sm">
                  {Math.floor(result.monthsToPayoff / 12) > 0 && (
                    <span>
                      {Math.floor(result.monthsToPayoff / 12)}
                      <span className="text-2xl font-medium text-red-300 mx-1">
                        yrs
                      </span>
                    </span>
                  )}
                  {result.monthsToPayoff % 12}
                  <span className="text-2xl font-medium text-red-300 ml-1">
                    moss
                  </span>
                </div>
                <div className="text-red-200 text-sm mt-3 font-medium bg-red-800/50 inline-block px-3 py-1 rounded-full border border-red-600">
                  {result.monthsToPayoff} total payments
                </div>
              </div>
              ...
              <div className="p-6 flex-grow space-y-4 bg-gray-50 flex flex-col justify-center">
                ...
                <div className="flex justify-between items-center bg-white p-4 rounded-xl border border-gray-200">
                  ...
                  <span className="font-bold text-lg text-gray-800">
                    $
                    {result.totalPaid.toLocaleString("en-US", {
                      minimumFractionDigits: 2,
                      maximumFractionDigits: 2,
                    })}
                  </span>
      ...
      <div className="mt-8">
        <CalculatorSEO
          ...
          whatIsIt={
            <>
              <p>
                The <strong>Debt Payoff Calculator</strong> allows you to build
                a structured amortization schedule for credit cards, personal
                loans, or auto loans. It mathematically calculates exactly the
                day you will become debt-free and reveals the total interest
                cost of carrying the balance.
              </p>
              <p>
                Debt mathematically guarantees negative compounding. By
                visualizing the true, long-term cost of minimum payments,
                borrowers are empowered to build aggressive payoff strategies
                like the <em>Debt Snowball</em> or <em>Debt Avalanche</em>.
              </p>

              <p className="mt-4 text-sm text-gray-500">
                <strong>Related Terms:</strong> Debt Payoff Calculator, Debt
                Calculator, Debt Ratio Formula
              </p>
            </>
          }
          formula={
          ...
          example={
            <>
              <p>
                Consider a <strong>$10,000</strong> credit card balance with an
                aggressive <strong>18.9% APR</strong>.
              </p>
              <ul className="list-disc pl-6 space-y-2 mt-4 text-gray-700">
                <li>
                  If you pay a steady <strong>$300</strong> a month: It will
                  take you exactly <strong>47 months</strong> (just under 4
                  years) to escape the debt. You will pay the bank{" "}
                  <strong>$3,927</strong> in pure interest over that time.
                </li>
                <li>
                  If you aggressively double your payment to{" "}
                  <strong>$600</strong> a month: You will be debt-free in just{" "}
                  <strong>20 months</strong>, and your total interest drops to
                  only <strong>$1,643</strong>.
                </li>
                <li>
                  <strong>The Reality Check:</strong> Paying an extra $300 a
                  month saves you over $2,284 and buys back three whole years of
          ...
          useCases={
            <ul className="list-disc pl-6 space-y-4 text-gray-700">
              <li>
                <strong>Debt Avalanche Strategy:</strong> Sorting all of your
                active debts by the highest APR and mathematically proving how
                much money you save by attacking the 24% credit card before the
                6% student loan.
              </li>
              <li>
                <strong>Minimum Payment Warnings:</strong> Visualizing how
                paying only the variable minimum amount determined by credit
                card companies is mathematically designed to keep you trapped in
                debt for 15+ years.
              </li>
              <li>
                <strong>Refinance Checking:</strong> Determining if the
                origination fee of taking out an 8% personal loan is
                mathematically worth it to consolidate and immediately wipe out
                a 21% credit card balance.
              </li>
            </ul>
          }
          faqs={[
