  ...
  return (
    <div className="max-w-5xl mx-auto p-4 md:p-8 bg-white rounded-xl shadow-lg border border-gray-100">
      ...
      <p className="mb-8 text-gray-600 text-lg">
        Calculate your exact monthly car lease payment including depreciation,
        rent charges, and sales tax.
      </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-slate-50 p-6 rounded-xl border border-slate-200 space-y-5">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border-gray-300 p-3 shadow-sm focus:border-slate-500 font-bold text-slate-700"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 border-t border-slate-200 pt-4">
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border-gray-300 p-3 shadow-sm focus:border-slate-500"
              />
            </div>
            <div>
              <label className="block text-sm font-semibold text-slate-700 mb-1">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                onChange={(e) => setResidualValuePct(e.target.value)}
                className="w-full rounded-lg border-gray-300 p-3 shadow-sm focus:border-slate-500"
              />
              <p className="text-xs text-slate-500 mt-1">
          ...
          <button
            ...
            className="w-full bg-slate-800 text-white font-bold py-4 rounded-xl hover:bg-slate-900 transition shadow-lg uppercase tracking-wide mt-4"
          >
            Calculate Payment
          </button>
        </div>
        ...
        <div className="bg-white border-2 border-slate-200 rounded-xl overflow-hidden shadow-sm flex flex-col items-center justify-center p-8">
          {result !== null ? (
            <div className="w-full text-center space-y-6">
              <div>
                <h3 className="text-slate-800 font-semibold uppercase tracking-wider text-sm mb-2">
                  Total Monthly Payment
                </h3>
                <div className="text-6xl font-black text-gray-900 drop-shadow-sm border-b border-slate-100 pb-4">
                  $
                  {result.monthlyPaymentTotal.toLocaleString("en-US", {
              ...
              <div>
                <h3 className="text-slate-500 font-bold uppercase text-xs mb-3 text-left">
                  Monthly Breakdown
                </h3>
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between items-center bg-slate-50 p-3 rounded text-sm text-slate-700">
                    ...
                    <span className="font-bold border-b border-slate-300">
                      ${result.monthlyFinance.toFixed(2)}
                    </span>
                  </div>
                  <div className="flex justify-between items-center bg-slate-100 p-3 rounded text-sm text-slate-800 font-semibold border border-slate-200">
                    ...
                    <span>
                      $
                      {(
                        result.monthlyDepreciation + result.monthlyFinance
                      ).toFixed(2)}
                    </span>
                  </div>
              ...
              <div className="bg-green-50 p-4 rounded border border-green-200 text-left">
                ...
                <p className="text-2xl font-black text-green-700">
                  $
                  {result.totalLeaseCost.toLocaleString("en-US", {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2,
                  })}
                </p>
                <p className="text-xs text-green-600 mt-1 font-medium">
                  Sum of all {leaseTerm} payments + Down Payment + Trade-In
                </p>
              </div>
            </div>
          ) : (
            <div className="text-slate-400 font-medium text-center text-lg max-w-xs">
              Enter the vehicle pricing and lease terms to see your accurate
      ...
      <CalculatorSEO
        ...
        whatIsIt={
          <>
            <p>
              Our <strong>Auto Lease Calculator</strong> is a specialized
              financial tool designed to deconstruct and demystify standard
              dealership lease contracts. When you lease a vehicle, you are not
              buying the car; you are solely paying for the amount of value the
              car loses (depreciation) during the time you drive it, plus a
              borrowing fee (rent charge).
            </p>
            <p>
              Dealerships often obscure the true cost of a lease by focusing
              entirely on the "Monthly Payment." This calculator breaks the math
              completely open, showing you exactly how much of your payment goes
              toward actual vehicle depreciation, how much is pure interest via
              the <strong>Money Factor</strong>, and how taxes are applied.
            </p>
          </>
        }
        formula={
          <>
            <p>
              A monthly lease payment is always composed of three distinct
              mathematical buckets: Depreciation, the Rent Charge (Interest),
              and Taxes.
            </p>
            <div className="bg-slate-50 p-4 rounded-lg font-mono text-center text-[14px] shadow-sm my-4 flex flex-col gap-2 border border-slate-200 text-slate-900">
              <p>
                <strong>1. Cap Cost</strong> = Negotiated Price - Down Payment -
                Trade In
              </p>
              <p>
                <strong>2. Depreciation Fee</strong> = (Cap Cost - Residual
                Value) ÷ Lease Term
              </p>
              <p>
                <strong>3. Rent Charge</strong> = (Cap Cost + Residual Value) ×
                Money Factor
              </p>
              <p className="border-t border-slate-200 pt-3 mt-2 text-sm">
                <strong>Total Monthly</strong> = (Depreciation + Rent Charge) ×
                (1 + Tax Rate)
              </p>
            </div>
          </>
        ...
        example={
          <>
            <p>
              You want to lease a <strong>$35,000 MSRP</strong> car. You
              negotiate the price down to <strong>$33,000</strong>. You put{" "}
              <strong>$2,000 down</strong> for <strong>36 months</strong>. The
              dealer gives you a <strong>55% Residual</strong> and a{" "}
              <strong>4.5% APR</strong>.
            </p>
            <ul className="list-disc pl-6 space-y-2 mt-4 text-slate-700">
              <li>
                <strong>Cap Cost:</strong> $33,000 - $2,000 = $31,000.
              </li>
              <li>
                <strong>Residual:</strong> $35,000 × 0.55 = $19,250.
              </li>
              <li>
                <strong>Depreciation Fee:</strong> ($31,000 - $19,250) ÷ 36 ={" "}
                <strong>$326.38/mo</strong>.
              </li>
              <li>
                <strong>Rent Charge:</strong> Convert 4.5% APR to Money Factor
                (4.5 ÷ 2400) = 0.001875. Then, ($31,000 + $19,250) × 0.001875 ={" "}
                <strong>$94.21/mo</strong>.
              </li>
              <li>
                <strong>Result:</strong> Before tax, your exact base lease
                payment is $326.38 + $94.21 = <strong>$420.59 per month</strong>
                .
              </li>
            </ul>
          </>
        ...
        useCases={
          <ul className="list-disc pl-6 space-y-4 text-slate-700">
            <li>
              <strong>Negotiating at the Dealership:</strong> By knowing exactly
              how the Money Factor and Residual Value dictate the final cost,
              you can spot when a dealer is artificially inflating the interest
              rate to boost their profit margin over the advertised deal.
            </li>
            <li>
              <strong>Lease vs. Buy Analysis:</strong> Comparing the total
              3-year out-of-pocket cost of this lease versus the estimated
              depreciation curve of buying the car outright and selling it
              yourself in 36 months.
            </li>
            <li>
              <strong>Evaluating "Zero Down" Offers:</strong> Running the math
              to see if putting $3,000 down is actually worth it to lower the
              monthly payment, or if you end up paying the exact same Total
              Lease Cost regardless of the down payment.
            </li>
          </ul>
        }
        faqs={[
        ...
        relatedCalculators={[
          {
            ...
            desc: "Calculate the exact fuel efficiency of your vehicle.",
          },
          {
            name: "ROI Calculator",
            path: "/roi-calculator",
