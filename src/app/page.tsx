  ...
  const categories = [
    ...
    },
    {
      ...
      calculators: [
        ...
        { name: 'Hex Calculator', path: '/hex-calculator', desc: 'Perform addition, subtraction, multiplication, division, and bitwise operations on Hexadecimal numbers.' },
        { name: 'Cubic Equation Calculator', path: '/cubic-equation-calculator', desc: 'Find the real and complex roots of any cubic equation.' },
        { name: 'Distance Calculator', path: '/distance-calculator', desc: 'Calculate the exact distance between two points on a 2D Cartesian coordinate plane.' },
        { name: 'Midpoint Calculator', path: '/midpoint-calculator', desc: 'Find the exact midpoint halfway between two given coordinates.' },
        { name: 'Logarithm Calculator', path: '/logarithm-calculator', desc: 'Calculate the logarithm of any positive real number using a custom base, base 10, or base e.' },
        { name: 'Exponent Calculator', path: '/exponent-calculator', desc: 'Calculate exactly how powerful your base becomes when multiplied by itself n times.' },
