  ...
  return (
    <div className="max-w-4xl mx-auto p-8 bg-white rounded-lg shadow-sm border border-gray-100 my-8">
      ...
      <div className="prose prose-blue prose-lg text-gray-700 max-w-none">
        <p>
          At <strong>Calculator All</strong>, accessible from our website, one
          of our main priorities is the privacy of our visitors. This Privacy
          Policy document contains types of information that is collected and
          recorded by Calculator All and how we use it.
        </p>

        <p>
          If you have additional questions or require more information about our
          Privacy Policy, do not hesitate to contact us at{" "}
          <a href="mailto:harshal.cloud.aws@gmail.com">
        ...
        <p>
          <strong>Note regarding our calculators:</strong> All calculations
          performed on our website are executed locally in your browser
          (client-side). We do not store, transmit, or save the data you enter
          into the calculators (like financial figures, health metrics, etc.) on
          our servers.
        </p>
        ...
        <p>
          Like any other website, Calculator All uses &quot;cookies&quot;. These
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">
          3. Google DoubleClick DART Cookie &amp; Google AdSense
        </h2>
        <p>
        ...
        <p>
          ...
          advertising partners of Calculator All.
        </p>
        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Calculator All, which are sent
        ...
        <p>
          Note that Calculator All has no access to or control over these
        ...
        <p>
          Calculator All&apos;s Privacy Policy does not apply to other
        ...
        <p>
          ...
          monitor and analyze the use of our Service. These providers use
          cookies and similar tracking technologies to track the activity on our
          Service and hold certain information to help us improve the website.
        </p>
        ...
        <p>
          Calculator All does not knowingly collect any Personal Identifiable
        ...
        <p>
          ...
          shared and/or collect in Calculator All. This policy is not applicable
