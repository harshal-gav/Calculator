export const metadata = {
    ...
    description: 'Privacy Policy for Calculator All',
};
    ...
    return (
        <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-sm my-8">
            ...
            <div className="prose prose-blue text-gray-700">
                <p>Your privacy is important to us. It is Calculator All's policy to respect your privacy regarding any information we may collect from you across our website.</p>
