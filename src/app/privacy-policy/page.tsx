export const metadata = {
    ...
    description: 'Privacy Policy for Calculator All - Learn how we collect, use, and protect your information.',
};
...
export default function PrivacyPolicy() {
    return (
        <div className="max-w-4xl mx-auto p-8 bg-white rounded-lg shadow-sm border border-gray-100 my-8">
            ...
            <p className="text-sm text-gray-500 mb-8 pb-4 border-b border-gray-200">Last updated: {new Date().toLocaleDateString()}</p>

            <div className="prose prose-blue prose-lg text-gray-700 max-w-none">
                <p>
                    At <strong>Calculator All</strong>, accessible from our website, one of our main priorities is the privacy of our visitors.
                    This Privacy Policy document contains types of information that is collected and recorded by Calculator All and how we use it.
                </p>

                <p>
                    If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us at <a href="mailto:harshal.cloud.aws@gmail.com">harshal.cloud.aws@gmail.com</a>.
                </p>
                ...
                <p>
                    <strong>Note regarding our calculators:</strong> All calculations performed on our website are executed locally in your browser (client-side). We do not store, transmit, or save the data you enter into the calculators (like financial figures, health metrics, etc.) on our servers.
                </p>
                ...
                <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">4. Advertising Partners Privacy Policies</h2>
                <p>
                ...
                <p>
                    Calculator All does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such information from our records.
                </p>

                <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">8. Online Privacy Policy Only</h2>
                <p>
                    This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in Calculator All. This policy is not applicable to any information collected offline or via channels other than this website.
                </p>

                <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">9. Consent</h2>
                <p>
