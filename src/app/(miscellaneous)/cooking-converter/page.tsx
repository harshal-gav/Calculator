...
export default function CookingConverter() {
  ...
  const calculate = () => {
    const fromMultiplier =
      (units.find((u) => u.id === fromUnit)?.[
        standardFactor as keyof (typeof units)[0]
      ] as any as number) || 1;
    const toMultiplier =
      (units.find((u) => u.id === toUnit)?.[
        standardFactor as keyof (typeof units)[0]
      ] as any as number) || 1;
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8 bg-orange-50 rounded-xl shadow-lg border border-orange-100">
      ...
      <p className="mb-8 text-orange-700 text-lg">
        Instantly convert recipe volumes and weights between metric and imperial
        systems.
      </p>
      ...
      <div className="bg-white p-6 md:p-10 rounded-2xl border border-orange-200 shadow-sm relative">
        ...
        <div className="absolute top-0 right-0 p-8 opacity-5 pointer-events-none">
          <svg
            ...
            className="h-48 w-48 text-orange-900"
            viewBox="0 0 24 24"
            fill="currentColor"
          >
            {mode === "volume" ? (
        ...
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-[1fr,auto,1fr] gap-6 items-center">
          ...
          <div className="space-y-3">
            <label className="block text-sm font-bold text-orange-800 uppercase tracking-widest text-center shadow-sm py-2 rounded-t-lg bg-orange-100 border-x border-t border-orange-200 -mb-3 z-0 relative">
              Convert From
            </label>
          ...
          {/* To Input */}
          <div className="space-y-3">
            <label className="block text-sm font-bold text-emerald-800 uppercase tracking-widest text-center shadow-sm py-2 rounded-t-lg bg-emerald-100 border-x border-t border-emerald-200 -mb-3 z-0 relative">
              Convert To
            </label>
      ...
      <div className="mt-8 bg-white p-6 rounded-2xl border border-orange-200 shadow-sm">
        <h3 className="font-bold text-orange-900 border-b border-orange-100 pb-2 mb-4 uppercase tracking-wider text-sm">
          Equivalent Chart
        </h3>
      ...
      <div className="mt-8 text-left">
        <CalculatorSEO
          ...
          whatIsIt={
            <p>
              The <strong>Cooking Measurement Converter</strong> is an essential
              kitchen utility designed to instantly translate recipe ingredients
              across different global measurement systems. It seamlessly
              switches between US Imperial Volume (cups, fluid ounces,
              tablespoons), US Imperial Weight (pounds, ounces), and the
              standard Metric system (grams, kilograms, milliliters).
            </p>
          }
          formula={
          <>
          ...
          example={
            <>
              <p>
                Let's convert a traditional American measurement of{" "}
                <strong>1.5 Cups of Milk</strong> into precise European Metric
                Milliliters.
              </p>
              <ul className="list-disc pl-6 space-y-2 mt-4 text-orange-800">
                <li>
                  <strong>The Conversion Ratio:</strong> In the US legal system
                  meant for nutrition labeling, exactly 1 standard cup equals
                  240 milliliters.
                </li>
                <li>
                  <strong>The Math:</strong> 1.5 (cups) × 240 (mL per cup)
                </li>
                <li>
                  <strong>Result:</strong> Your recipe requires exactly{" "}
                  <strong>360 Milliliters</strong> of milk.
                </li>
              </ul>
            </>
          }
          useCases={
            <ul className="list-disc pl-6 space-y-4 text-orange-800">
              <li>
                <strong>International Baking Recipes:</strong> Translating a
                traditional French pastry recipe recorded strictly by weight in
                Grams into equivalent US Cups and Tablespoons because you do not
                own a kitchen scale.
              </li>
              <li>
                <strong>Portion Scaling:</strong> A chef needs to quadruple a
                small dinner recipe for a large catering event. Calculating 4 ×
                3/4 Cups is tedious; converting the base into total fl oz or mL
                makes bulk division significantly easier.
              </li>
              <li>
                <strong>Dietary Logging:</strong> Using the weight converter
                (Grams to Ounces) to accurately log the protein mass of a
                chicken breast into a fitness tracking application that defaults
                to Imperial units.
              </li>
            </ul>
          }
          faqs={[
            {
              question:
                "Why can't I convert Cups directly into Grams on this tool?",
              answer:
                "Because a Cup measures the 'Volume' (physical space) an ingredient takes up, while Grams measure 'Weight' (density/mass). A cup of lead weighs drastically more than a cup of feathers. To convert volume to weight, you must first know the exact substance's specific gravity density!",
            },
            {
              question: "Is there a difference between a US Cup and a UK Cup?",
              answer:
                "Yes! A US Customary Cup holds roughly 236.6mL. A UK Imperial Cup holds roughly 284mL. To ensure standardized accuracy, this calculator defaults to the US Legal Cup (exactly 240mL) used uniformly on modern nutrition labels.",
            },
            {
              question:
                "What is the difference between a Fluid Ounce and a Dry Ounce?",
              answer:
                "A Fluid Ounce (fl oz) strictly measures Volume (like milk or water). A standard Ounce (oz) strictly measures Weight (like flour or sugar). They are two entirely different mathematical frameworks!",
            },
          ]}
          relatedCalculators={[
            {
