...
export default function ShoeSizeConverter() {
  ...
  const result = isNaN(currentValue)
    ? null
    : findClosestSize(currentValue, selectedSystem);
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8 bg-neutral-900 rounded-xl shadow-2xl border border-neutral-800 text-neutral-200">
      ...
      <p className="mb-8 text-neutral-400 text-lg">
        Instantly convert adult shoe sizes between US (Men/Women), UK, EU, and
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
        ...
        <div className="bg-neutral-800 p-6 md:p-8 rounded-2xl border border-neutral-700 shadow-inner">
          <label className="block text-sm font-bold text-neutral-400 mb-4 uppercase tracking-wider">
            Select Your Starting Size
          </label>
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-3 bg-blue-900/20 p-4 rounded-xl border border-blue-500/20">
              ...
              <p className="text-xs text-blue-200/70">
                Shoe sizing varies heavily by brand (Nike, Adidas, etc.). These
                conversions represent the most common international standard
                equivalents used by major manufacturers.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-neutral-800 to-neutral-900 p-6 md:p-8 rounded-2xl border border-neutral-700 shadow-lg relative overflow-hidden">
          ...
          <div className="relative z-10 w-full h-full flex flex-col justify-center">
            <h3 className="font-bold text-neutral-500 uppercase tracking-widest text-xs mb-6 text-center border-b border-neutral-700 pb-2">
              Equivalent Sizes
            </h3>
            ...
            {result ? (
              <div className="grid grid-cols-2 gap-4">
                <div
                  className={`bg-neutral-900 p-4 rounded-xl border flex flex-col items-center justify-center transition-all ${selectedSystem === "us_m" ? "border-purple-500 bg-purple-900/10" : "border-neutral-800"}`}
                >
                  <div className="text-[10px] font-bold text-neutral-500 uppercase tracking-widest mb-1">
                    US Men
                  </div>
                  <div className="text-3xl font-black text-white">
                    {result.us_m.toFixed(1)}
                  </div>
                </div>
                <div
                  className={`bg-neutral-900 p-4 rounded-xl border flex flex-col items-center justify-center transition-all ${selectedSystem === "us_w" ? "border-purple-500 bg-purple-900/10" : "border-neutral-800"}`}
                >
                  <div className="text-[10px] font-bold text-neutral-500 uppercase tracking-widest mb-1">
                    US Women
                  </div>
                  <div className="text-3xl font-black text-white">
                    {result.us_w.toFixed(1)}
                  </div>
                </div>
                <div
                  className={`bg-neutral-900 p-4 rounded-xl border flex flex-col items-center justify-center transition-all ${selectedSystem === "uk" ? "border-purple-500 bg-purple-900/10" : "border-neutral-800"}`}
                >
                  <div className="text-[10px] font-bold text-neutral-500 uppercase tracking-widest mb-1">
                    UK
                  </div>
                ...
                <div
                  className={`bg-neutral-900 p-4 rounded-xl border flex flex-col items-center justify-center transition-all ${selectedSystem === "eu" ? "border-purple-500 bg-purple-900/10" : "border-neutral-800"}`}
                >
                  <div className="text-[10px] font-bold text-neutral-500 uppercase tracking-widest mb-1">
                    EU
                  </div>
                ...
                <div
                  className={`col-span-2 bg-neutral-950 p-4 rounded-xl border flex justify-between items-center px-8 transition-all ${selectedSystem === "cm" ? "border-purple-500 bg-purple-900/10" : "border-neutral-800"}`}
                >
      ...
      <div className="mt-8 text-left">
        <CalculatorSEO
          ...
          whatIsIt={
            <p>
              The <strong>Shoe Size Converter</strong> is a global sizing
              utility designed to alleviate the frustration of international
              online shopping. It instantly maps and translates adult shoe sizes
              across the four dominant global manufacturing standards: United
              States (Men & Women), United Kingdom, European Union, and Japanese
              Centimeters.
            </p>
          }
          formula={
          ...
          example={
            <>
              <p>
                Let's convert a standard common size for an international
                sneaker purchase.
              </p>
              <ul className="list-disc pl-6 space-y-2 mt-4 text-neutral-400">
                <li>
                  <strong>The Input:</strong> You wear a standard Size 10 in US
                  Men's.
                </li>
                <li>
                  <strong>The Matrix Search:</strong> The algorithm locates US_M
                  = 10.0 in the equivalence database.
                </li>
                <li>
                  <strong>The Translation:</strong> It simultaneously pulls the
                  corresponding values attached to that data row.
                </li>
                <li>
                  <strong>Result:</strong> Your equivalent size is{" "}
                  <strong>US Women's 11.5</strong>, <strong>UK 9.5</strong>,{" "}
                  <strong>EU 44.0</strong>, or <strong>28.0 Centimeters</strong>
                  .
                </li>
              </ul>
            </>
          ...
          useCases={
            <ul className="list-disc pl-6 space-y-4 text-neutral-400">
              <li>
                <strong>Online Sneaker Shopping:</strong> Buying limited-edition
                streetwear from European boutiques (like END Clothing) where all
                inventory is strictly listed in UK or EU sizing instead of US.
              </li>
              <li>
                <strong>Gender Style Crossovers:</strong> A woman wanting to buy
                a pair of traditionally "Men's only" released Air Jordans needs
                to subtract 1.5 from her normal US Women's size to order the
                mathematically correct Men's equivalent box.
              </li>
              <li>
                <strong>Athletic Precision:</strong> Olympic powerlifters and
                runners heavily rely on the 'Centimeter (CM / JP)' measurement,
                as it strictly defines the literal physical length of the
                insole, removing the subjective vanity sizing of
          ...
          faqs={[
            {
              ...
              answer:
                "No. While they follow international guidelines, every manufacturer uses proprietary 'lasts' (the mold a shoe is built on). A Nike size 10 often fits slightly tighter than an Adidas size 10. This tool provides the most accurate mathematical baseline available.",
            },
            {
              question: "Why are US Men's and Women's sizes different numbers?",
              answer:
                "Historically, American shoemakers developed separate scales for men and women rather than one unified scale. By industry standard, a US Women's size is numerically labeled 1.5 sizes larger than the exact same physical length in a Men's shoe.",
            },
            {
              question: "What does CM or JP mean in shoe sizing?",
              answer:
                "CM stands for Centimeters, and JP refers to the Japanese sizing system. It is considered the most logical system globally because your 'Size' is literally just the measuring-tape length of your foot in centimeters. No barleycorns, no Paris points, just pure metric distance.",
            },
          ]}
          relatedCalculators={[
            {
