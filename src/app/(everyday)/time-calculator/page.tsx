    ...
    return (
        <div className="max-w-4xl mx-auto p-4 md:p-8 bg-white rounded-xl shadow-lg border border-gray-100">
            ...
            <CalculatorSEO
                ...
                whatIsIt={
                    <>
                        <p>Our <strong>Time Calculator</strong> is a specialized utility designed to instantly add or subtract two distinct blocks of time. While standard calculators struggle with the sexagesimal (base-60) number system used for modern clocks, our tool processes hours, minutes, and seconds natively.</p>
                        <p>Whether you need to calculate total hours worked on a timesheet, subtract splits during a marathon, or determine the total runtime of a video playlist, this calculator instantly outputs the exact duration in a standard HH:MM:SS format.</p>
                    </>
                }
                formula={
                    <>
                        <p>Time mathematics requires converting all values into their smallest base unit (seconds), performing standard arithmetic, and then breaking the result back out into base-60 chunks.</p>
                        <div className="bg-white p-4 rounded-lg font-mono text-center text-[15px] shadow-sm my-4 overflow-x-auto space-y-4 text-violet-900 border border-violet-100">
                            <p><strong>Total Seconds =</strong> (Hours × 3600) + (Minutes × 60) + Seconds</p>
                            <p className="border-t border-violet-100 pt-4 mt-4 text-sm font-sans text-left text-gray-700"><strong>Conversion Back:</strong><br />1. Hours = Floor(Total Seconds ÷ 3600)<br />2. Minutes = Floor(Remaining Seconds ÷ 60)<br />3. Seconds = Remaining Seconds</p>
                        </div>
                    </>
                }
                example={
                    <>
                        <p>Let's find the total time of an audio project by adding <strong>2 hours, 45 minutes, and 30 seconds</strong> to <strong>1 hour, 30 minutes, and 45 seconds</strong>.</p>
                        <ul className="list-disc pl-6 space-y-2 mt-4">
                            <li><strong>Step 1 (Combine Seconds):</strong> 30 + 45 = 75 seconds. Because this is over 60, we keep <strong>15 seconds</strong> and carry 1 minute over.</li>
                            <li><strong>Step 2 (Combine Minutes):</strong> 45 + 30 + 1 (carried) = 76 minutes. We keep <strong>16 minutes</strong> and carry 1 hour over.</li>
                            <li><strong>Step 3 (Combine Hours):</strong> 2 + 1 + 1 (carried) = <strong>4 hours</strong>.</li>
                            <li><strong>Result:</strong> Exactly 4 hours, 16 minutes, and 15 seconds (04:16:15).</li>
                        </ul>
                    </>
                }
                useCases={
                    <ul className="list-disc pl-6 space-y-4">
                        <li><strong>Payroll and Hourly Billing:</strong> Accurately summing up timestamps across a two-week period to invoice clients or process employee timesheets without losing money to rounding errors.</li>
                        <li><strong>Media Editing:</strong> Video editors determining exact frame cut-points or calculating the total runtime of a multi-scene film sequence.</li>
                        <li><strong>Aviation Logbooks:</strong> Pilots logging flight time natively in hours and minutes to meet strict FAA regulatory hours requirements.</li>
                        <li><strong>Athletic Training:</strong> Runners and cyclists adding interval laps together to determine their total active workout duration.</li>
                    </ul>
                }
                faqs={[
                    {
                        question: "Can I enter more than 60 minutes or 60 seconds into the inputs?",
                        answer: "Yes! If you enter '0 Hours, 90 Minutes', our calculator will automatically interpret and reformat it as 1 Hour and 30 Minutes behind the scenes before performing the requested calculation."
                    },
                    {
                        question: "What happens if I subtract a larger time from a smaller time?",
                        answer: "The calculator natively handles negative time outcomes. For example, subtracting 2 hours from 1 hour will mathematically result in '-1 Hours'. This mathematical flexibility is crucial for calculating complex offset differences and countdown timers."
                    },
                    {
                        question: "Why do standard calculators fail at time math?",
                        answer: "Standard calculators use a base-10 (decimal) system, meaning they roll over every 10, 100, or 1000. Time uses a base-60 system (60 seconds, 60 minutes). If you try to add 1.30 + 1.45 on a normal calculator, it gives you 2.75, rather than the correct time of 3 hours and 15 minutes."
                    }
                ]}
                relatedCalculators={[
