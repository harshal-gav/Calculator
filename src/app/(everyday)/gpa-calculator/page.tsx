...
export default function GPACalculator() {
  ...
  const gradedCourses = courses.filter(
    (c) => c.grade !== "" && c.credits !== "" && !isNaN(parseFloat(c.credits)),
  );
  ...
  return (
    <div className="max-w-5xl mx-auto p-4 md:p-8 bg-amber-50 rounded-xl shadow-lg border border-amber-200">
      ...
      <p className="mb-8 text-amber-800 text-lg">
        Enter your course list, credits, and expected grades to instantly
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="bg-white p-6 rounded-xl border border-amber-200 shadow-sm">
            <div className="grid grid-cols-12 gap-4 mb-4 font-bold text-xs uppercase tracking-widest text-amber-700 border-b border-amber-100 pb-2 hidden md:grid">
              ...
              <div className="col-span-2 text-center border-amber-100">
                Credits
              </div>
              <div className="col-span-3 text-center border-amber-100">
                Letter Grade
              </div>
            </div>
            ...
            {courses.map((course, index) => (
              <div
                key={course.id}
                className="grid grid-cols-1 md:grid-cols-12 gap-2 md:gap-4 mb-4 items-center bg-amber-50 p-3 rounded-lg border border-amber-100 hover:bg-amber-100 transition-colors"
              >
                ...
                <div className="col-span-6 md:col-span-3">
                  ...
                  >
                    ...
                    {GRADE_POINTS.map((gp, i) => (
                      <option key={i} value={gp.value.toString()}>
                        {gp.label}
                      </option>
                    ))}
                  </select>
        ...
        <div className="lg:col-span-1">
          <div className="bg-gradient-to-br from-amber-700 to-amber-900 rounded-xl p-8 text-white shadow-xl relative overflow-hidden border border-amber-800 h-full flex flex-col justify-center text-center">
            ...
            <div className="relative z-10 text-center">
              <h2 className="text-amber-200 font-bold uppercase tracking-widest text-xs mb-6">
                Cumulative GPA
              </h2>
            ...
            <div className="mt-auto border-t border-amber-600/50 pt-6">
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  <div className="text-amber-300 font-bold uppercase tracking-widest text-[10px] mb-1">
                    Total Points
                  </div>
