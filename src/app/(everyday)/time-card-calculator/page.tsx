...
import timeCardSeoData from "@/data/seo-content/official/time-card-calculator.json";
...
export default function TimeCardCalculator() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8 bg-zinc-50 rounded-2xl shadow-xl border border-zinc-200">
      ...
      <div className="mt-8">
      <CalculatorSEO
        title={timeCardSeoData.title}
        whatIsIt={timeCardSeoData.whatIsIt}
        formula={timeCardSeoData.formula}
        example={timeCardSeoData.example}
        useCases={timeCardSeoData.useCases}
        faqs={timeCardSeoData.faqs}
        deepDive={timeCardSeoData.deepDive}
        glossary={timeCardSeoData.glossary}
        relatedCalculators={[
          {
            name: "Salary Calculator",
            path: "/salary-calculator/",
            desc: "Convert your hourly wage into weekly, monthly, and yearly salary totals.",
          },
          {
            name: "Business Days",
            path: "/business-days-calculator/",
            desc: "Count exactly how many working days fall within a payroll cycle.",
          },
          {
            name: "Commission Calculator",
            path: "/commission-calculator/",
            desc: "Add variable sales bonuses on top of your hourly base pay.",
          },
          {
            name: "Overtime Calculator",
            path: "/overtime-calculator/",
            desc: "Calculate time-and-a-half pay for hours worked over forty.",
          }]}
      />
      </div>
    </div>
