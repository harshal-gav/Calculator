...
export default function DateCalculator() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8 bg-white rounded-xl shadow-lg border border-gray-100">
      <h1 className="text-4xl font-extrabold mb-4 text-sky-900 border-b pb-4">
        Date Calculator
      </h1>
      <p className="mb-8 text-gray-600 text-lg">
        Calculate the exact duration between two dates in years, months, and
        days.
      </p>
        ...
        <div className="bg-sky-50 p-6 rounded-xl border border-sky-100 space-y-6 flex flex-col justify-center">
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border-gray-300 p-3 shadow-sm focus:border-sky-500 font-medium text-lg text-gray-800"
            />
          </div>
        ...
        <div className="bg-white border-2 border-sky-100 rounded-xl overflow-hidden shadow-sm flex flex-col items-center justify-center p-8 min-h-[300px]">
          {result !== null ? (
            <div className="w-full text-center space-y-6">
              <div>
                <h3 className="text-sky-800 font-semibold uppercase tracking-wider text-sm mb-2">
                  Total Combined Days
                </h3>
                <div className="text-6xl font-black text-gray-900">
                  {Math.abs(result.totalDays)}{" "}
                  <span className="text-3xl text-gray-500 font-bold ml-1">
                    days
                  </span>
                </div>
                {result.totalDays < 0 && (
                  <span className="text-xs text-red-500 font-bold mt-1 inline-block uppercase bg-red-50 px-2 py-1 rounded">
                    Negative Time (End was before start)
                  </span>
                )}
              </div>
              ...
              <div>
                <h3 className="text-gray-500 font-bold uppercase text-xs mb-3">
                  Breakdown
                </h3>
