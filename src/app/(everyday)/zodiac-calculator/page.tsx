  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8 bg-black/95 rounded-xl shadow-2xl border border-gray-800">
      ...
      <p className="mb-8 text-gray-400 text-lg">
        Enter your birth date to instantly discover your astrological sun sign
        and ruling element.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-gray-900 p-6 md:p-8 rounded-2xl border border-gray-800 relative z-10 flex flex-col justify-center text-center">
          ...
          <div className="mt-8 text-xs text-gray-600">
            Astrology is an ancient practice that correlates the position of
            celestial bodies with human traits and events.
          </div>
        </div>

        {/* Results Screen */}
        <div
          className={`rounded-2xl border-2 overflow-hidden shadow-2xl flex flex-col justify-center text-white relative transition-all duration-700 ${result ? `bg-gradient-to-br ${result.bg} border-white/20` : "bg-gray-900 border-gray-800"}`}
        >
          ...
          <div
            ...
            style={{
              backgroundImage:
                "radial-gradient(1px 1px at 20px 30px, #ffffff, rgba(0,0,0,0)), radial-gradient(1px 1px at 40px 70px, #ffffff, rgba(0,0,0,0)), radial-gradient(1px 1px at 50px 160px, #ffffff, rgba(0,0,0,0)), radial-gradient(1.5px 1.5px at 90px 40px, #ffffff, rgba(0,0,0,0)), radial-gradient(2px 2px at 130px 80px, #ffffff, rgba(0,0,0,0))",
          ...
          {result ? (
            <div className="p-8 text-center z-10 animate-fade-in">
              <h3 className="text-white/70 font-bold uppercase tracking-widest text-xs mb-2">
                Your Sun Sign Is
              </h3>
              ...
              <div className="bg-black/30 backdrop-blur-sm rounded-xl p-4 border border-white/10 text-center">
                <h2 className="text-4xl font-black mb-1 drop-shadow-lg tracking-wide">
                  {result.sign}
                </h2>
                <p className="text-white/80 font-medium tracking-widest uppercase text-xs mb-3">
                  {result.range}
                </p>
