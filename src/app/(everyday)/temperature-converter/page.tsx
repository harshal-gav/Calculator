...
import temperatureSeoData from "@/data/seo-content/official/temperature-converter.json";
...
export default function TemperatureConverter() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8 bg-white rounded-xl shadow-lg border border-gray-100">
      ...
      <div className="mt-8">
        <CalculatorSEO
          title={temperatureSeoData.title}
          whatIsIt={temperatureSeoData.whatIsIt}
          formula={temperatureSeoData.formula}
          example={temperatureSeoData.example}
          useCases={temperatureSeoData.useCases}
          faqs={temperatureSeoData.faqs}
          deepDive={temperatureSeoData.deepDive}
          glossary={temperatureSeoData.glossary}
          relatedCalculators={[
            {
            ...
            },
            {
              ...
              desc: "Convert between MPH, KPH, and Knots.",
            },
            {
