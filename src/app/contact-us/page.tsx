export const metadata = {
    title: 'Contact Us',
    description: 'Get in touch with Calculator All',
};
    ...
    return (
        <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-sm my-8">
            ...
            <div className="mt-8 pt-8 border-t border-gray-200">
                ...
                <p className="text-gray-600">Email: <a href="mailto:harshal.cloud.aws@gmail.com" className="text-blue-600 hover:underline">harshal.cloud.aws@gmail.com</a></p>
            </div>
        </div>
    );
}
