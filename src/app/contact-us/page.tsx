...
export default function ContactUs() {
    ...
    return (
        <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-sm border mt-8 mb-16">
            <h1 className="text-3xl font-bold mb-6 text-gray-900 border-b pb-4">Contact Us</h1>
            <p className="mb-6 text-gray-700 leading-relaxed">Have a question, feedback, or a suggestion for a new calculator? We'd love to hear from you. Fill out the form below and we'll get back to you as soon as possible.</p>
            ...
            {status === 'success' && (
                <div className="mb-6 bg-green-50 border border-green-200 text-green-800 rounded-md p-4 flex items-start">
                    ...
                    <div>
                        ...
                        <div className="mt-1 text-sm"><p>Thank you for reaching out! We've received your message.</p></div>
                    </div>
                </div>
            )}
            ...
            <div className="mt-10 pt-8 border-t border-gray-200">
                ...
                <div className="flex items-center text-gray-600">
                    <svg className="w-5 h-5 mr-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                    <p>Email: <a href="mailto:harshal.cloud.aws@gmail.com" className="text-blue-600 hover:text-blue-800 transition-colors">harshal.cloud.aws@gmail.com</a></p>
                </div>
            </div>
        </div>
    );
