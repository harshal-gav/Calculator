...
export default function AccelerationCalculator() {
  ...
  const calculate = () => {
    ...
    if (calcTarget === "acceleration") {
      ...
      if (isNaN(v_i) || isNaN(v_f) || isNaN(time) || time === 0)
      ...
      const v_i = parseFloat(vi);
      const v_f = parseFloat(vf);
      if (isNaN(acc) || isNaN(v_i) || isNaN(v_f) || acc === 0)
        return setResult(null);
    ...
    <div className="max-w-4xl mx-auto p-4 md:p-8 bg-zinc-50 rounded-2xl shadow-xl border border-zinc-200">
      <div className="text-center mb-10">
        ...
        <p className="text-emerald-700 text-lg max-w-2xl mx-auto">
          Determine acceleration, final velocity, initial velocity, or time
      ...
      <div className="bg-white p-6 md:p-10 rounded-2xl shadow-sm border border-zinc-200 mb-8">
        <div className="mb-8 p-4 bg-emerald-50 rounded-xl border border-emerald-100 flex flex-col items-center gap-4">
          <label className="font-bold text-emerald-900 whitespace-nowrap uppercase tracking-widest text-sm text-center">
            Solve For:
          </label>
      ...
      <div className="mt-8 bg-zinc-100 p-6 rounded-xl border border-zinc-200 text-sm text-zinc-600 max-w-2xl mx-auto text-center">
        ...
        <p className="mt-4 text-xs font-mono">
          Note: This calculator assumes constant acceleration and standard
          metric units (meters and seconds).
        </p>
      </div>
      ...
      <div className="mt-8">
        <CalculatorSEO
          ...
          whatIsIt={
            <>
              <p>
                Our <strong>Acceleration Calculator</strong> measures the rate
                at which an object changes its velocity over time. Using
                fundamental kinematic equations, it allows you to solve for
                uniform acceleration, initial velocity, final velocity, or
                elapsed duration.
              </p>
              <p>
                In physics, any change in speed or direction means an object is
                accelerating. Even if a car remains at exactly 60 mph, if it
                goes around a curve, it is technically accelerating because its
                directional vector is changing.
              </p>
            </>
          }
          formula={
          ...
          example={
            <>
              <p>
                Let's calculate the acceleration of a sports car merging onto a
                highway.
              </p>
              <ul className="list-disc pl-6 space-y-2 mt-4 text-gray-700">
                <li>
                  <strong>The Scenario:</strong> A car enters a highway on-ramp
                  at <strong>10 m/s</strong> (Initial Velocity). The driver
                  steps on the gas, and <strong>5 seconds</strong> later (Time),
                  the car is traveling at <strong>30 m/s</strong> (Final
                  Velocity).
                </li>
                <li>
                  <strong>The Change in Velocity:</strong> 30 m/s - 10 m/s = 20
                  m/s increase in speed.
                </li>
                <li>
                  <strong>The Calculation:</strong> 20 m/s ÷ 5 seconds ={" "}
                  <strong>4</strong>.
                </li>
                <li>
                  <strong>Result:</strong> The car accelerated at a constant
                  rate of <strong>4 m/s²</strong>. For every second that passed,
                  the car's speed increased by 4 meters per second.
                </li>
              </ul>
            </>
          }
          useCases={
            <ul className="list-disc pl-6 space-y-4 text-gray-700">
              <li>
                <strong>Automotive Engineering:</strong> Car manufacturers use
                acceleration metrics to define vehicle performance. The famous
                "0 to 60 mph in 3 seconds" metric is a pure measurement of
                intense positive acceleration.
              </li>
              <li>
                <strong>Space Exploration:</strong> NASA must perfectly
                calculate orbital acceleration. If a rocket accelerates too
                slowly, it will succumb to Earth's gravity and crash. If it
                accelerates too rapidly, the G-forces will crush the astronauts
                inside.
              </li>
              <li>
                <strong>Accident Reconstruction:</strong> Forensic experts
                calculate "negative acceleration" (deceleration) by measuring
                tire skid marks to determine exactly how fast a vehicle was
                traveling before it slammed on the brakes.
              </li>
            </ul>
          }
          faqs={[
            {
              ...
              answer:
                "Yes. Negative acceleration (often called deceleration) simply means the object is slowing down relative to its direction of travel. If a car goes from 60 mph to 0 mph, its acceleration is a negative value.",
            },
            {
              question: "What does 'm/s²' actually mean?",
              answer:
                "Meters per second squared (m/s²) is the standard metric unit for acceleration. It simply means 'meters per second, per second.' If gravity is 9.8 m/s², it means every single second an object falls, its speed increases by an additional 9.8 m/s.",
            },
            {
              question: "Is 'g-force' the same thing as acceleration?",
              answer:
                "Yes. G-force is just a way of expressing extreme acceleration relative to Earth's standard gravitational pull (1G = 9.8 m/s²). A fighter jet pulling '5Gs' is accelerating 5 times faster than standard freefall.",
            },
          ]}
          relatedCalculators={[
            {
