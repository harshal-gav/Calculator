  ...
  const calculateMolarMass = (f: string) => {
    ...
    try {
      ...
      if (f.includes("(") || f.includes(")")) {
        throw new Error(
          "Parentheses are not currently supported by this simple parser.",
        );
      }
      ...
      if (!/^[A-Za-z0-9]+$/.test(f) && f !== "") {
        throw new Error(
          "Invalid characters in formula. Use valid element symbols (e.g., C, H, O, Na).",
        );
      }
    ...
    <div className="max-w-4xl mx-auto p-4 md:p-8 bg-zinc-50 rounded-2xl shadow-xl border border-zinc-200">
      <div className="text-center mb-10">
        ...
        <p className="text-emerald-700 text-lg max-w-2xl mx-auto">
          Calculate the molar mass (molecular weight) of a chemical compound and
          analyze its elemental composition.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="h-full bg-emerald-900 rounded-2xl p-8 shadow-2xl relative overflow-hidden flex flex-col justify-center text-white border border-emerald-800">
          ...
          <div className="relative z-10 text-center">
            <h2 className="text-emerald-200 font-bold uppercase tracking-widest text-xs mb-4 border-b border-emerald-800/50 pb-4">
              Total Molar Mass
            </h2>
            ...
            {totalMass > 0 && elements.length > 0 && (
              <div className="bg-emerald-950/60 backdrop-blur-sm rounded-xl p-4 border border-emerald-800/50 text-left">
                <div className="text-xs text-emerald-400 uppercase font-bold tracking-wider mb-2 border-b border-emerald-800/50 pb-2">
                  Elemental Breakdown
                </div>
                <div className="space-y-2 max-h-48 overflow-y-auto pr-2 custom-scrollbar">
                  {elements.map((el, i) => (
                    <div
                      key={i}
                      className="flex justify-between items-center text-sm font-mono border-b border-emerald-800/30 pb-1 last:border-0 last:pb-0"
                    >
                      <div>
      ...
      <div className="mt-8 text-left">
        <CalculatorSEO
          ...
          whatIsIt={
            <p>
              The <strong>Molar Mass Calculator</strong> is a specialized
              chemistry tool that computes the exact atomic weight of any
              entered chemical formula. By automatically referencing the
              standard periodic table of elements, it multiplies the atomic mass
              of each individual element by its quantity in the molecule,
              providing both the total molar mass in grams per mole (g/mol) and
              a detailed elemental percentage breakdown.
            </p>
          }
          formula={
            <>
          ...
          example={
            <>
              <p>
                Let's calculate the molar mass of simple water, mathematically
                represented as <strong>H2O</strong> (two Hydrogen atoms, one
                Oxygen atom).
              </p>
              <ul className="list-disc pl-6 space-y-2 mt-4 text-emerald-800">
                <li>
                  <strong>Hydrogen (H):</strong> The atomic weight is roughly
                  1.008 g/mol. Since there are 2 atoms,{" "}
                  <strong>2 × 1.008 = 2.016 g/mol</strong>.
                </li>
                <li>
                  <strong>Oxygen (O):</strong> The atomic weight is roughly
                  15.999 g/mol. Since there is 1 atom,{" "}
                  <strong>1 × 15.999 = 15.999 g/mol</strong>.
                </li>
                <li>
                  <strong>The Summation:</strong> 2.016 + 15.999 ={" "}
          ...
          useCases={
            <ul className="list-disc pl-6 space-y-4 text-emerald-800">
              <li>
                <strong>Organic Chemistry:</strong> University students quickly
                validating the molecular density of complex carbon chains like
                Glucose (C6H12O6) to balance chemical reaction equations.
              </li>
              <li>
                <strong>Laboratory Preparation:</strong> Research scientists
                calculating exactly how many physical grams of raw Sodium
                Chloride (NaCl) they need to weigh on a scale to create a
                1-molar saline solution.
              </li>
              <li>
                <strong>Material Science:</strong> Engineers analyzing the mass
                percentage of iron within structural steel alloys to determine
                oxidation resistance and tensile strength.
              </li>
            </ul>
          }
          faqs={[
            {
              ...
              answer:
                "Because chemical notation demands it to avoid impossible elements. For instance, 'Co' represents the metal Cobalt. However, 'CO' represents Carbon Monoxide, a molecule made of one Carbon and one Oxygen. Capitalization changes the entire chemical reality.",
            },
            {
              question: "What is a 'Mole' in chemistry?",
              answer:
                "A mole is simply a massive number—specifically Avogadro's number: 6.022 × 10²³. Molar Mass tells you exactly how many physical grams it takes to hold 6.022 × 10²³ individual molecules of that specific substance.",
            },
            {
              question:
                "Does this calculator support parentheses like Ca(OH)2?",
              answer:
                "Currently, our streamlined parser requires expanded formulas without brackets. For Calcium Hydroxide, you would need to manually distribute the 2 and enter it as CaO2H2 to ensure accurate calculations.",
            },
          ]}
          relatedCalculators={[
            {
