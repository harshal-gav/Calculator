    ...
    <div className="max-w-4xl mx-auto p-4 md:p-8 bg-zinc-50 rounded-2xl shadow-xl border border-zinc-200">
      <div className="text-center mb-10">
        ...
        <p className="text-emerald-700 text-lg max-w-2xl mx-auto">
          Calculate agent commissions and net profit for real estate, sales, and
          affiliates.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div>
            ...
            <div className="relative">
              <span className="absolute left-4 top-1/2 -translate-y-1/2 font-bold text-zinc-400 text-xl">
                $
              </span>
              <input
                type="number"
          ...
          <div>
            ...
            <div className="relative">
              ...
              />
              <span className="absolute right-4 top-1/2 -translate-y-1/2 font-bold text-zinc-400 text-xl">
                %
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full z-10 relative">
            ...
            <div className="bg-black/30 p-6 rounded-xl border border-emerald-500/30 flex flex-col items-center text-center shadow-inner">
              ...
              <div className="font-mono text-zinc-300 tracking-tight font-bold text-4xl mt-2 truncate w-full">
                $
                {result.sellerRevenue.toLocaleString("en-US", {
                  minimumFractionDigits: 2,
                  maximumFractionDigits: 2,
                })}
              </div>
      ...
      <CalculatorSEO
        ...
        whatIsIt={
          <p>
            The <strong>Commission Calculator</strong> helps sales
            professionals, real estate agents, and business owners quickly
            determine their commission earnings and the net revenue received by
            the seller from a given sale price.
          </p>
        }
        formula={
          <>
            <p>
              The commission and net revenue are calculated using these
              straightforward percentage formulas:
            </p>
            <div className="bg-white p-4 rounded-lg font-mono text-center text-[15px] shadow-sm my-4 border border-zinc-200">
              <strong>Commission = Sale Price × (Commission Rate / 100)</strong>
              <br />
        ...
        example={
          <>
            <p>
              If you sell a property for $150,000 with a 5.5% commission rate:
            </p>
            <ul className="list-disc pl-6 space-y-2 mt-2">
              <li>
                Commission: 150,000 × 0.055 = <strong>$8,250</strong>
              </li>
              <li>
                Net to Seller: 150,000 − 8,250 = <strong>$141,750</strong>
              </li>
            </ul>
          </>
        }
        useCases={
          <ul className="list-disc pl-6 space-y-4">
            <li>
              <strong>Real Estate Agents:</strong> Quickly determine standard
              fee structures before finalizing listing agreements and
              forecasting personal income.
            </li>
            <li>
              <strong>Sales Teams & Referrals:</strong> Calculate affiliate
              payouts or finder's fees easily for closed deals.
            </li>
            <li>
              <strong>Sellers:</strong> Understand exactly how much cash you
              will take away from the total sale after closing costs and agent
        ...
        faqs={[
          {
            ...
            answer:
              "No, this is a gross commission calculator. For individuals working with a broker, you will often need to split the total commission amount further (e.g., a 50/50 broker split) and pay necessary income taxes on the remaining distribution.",
          },
          {
            question: "What is an average real estate commission rate?",
            answer:
              "In the United States, customary real estate commission rates typically hover between 5% and 6% of the total home sale price, often split evenly between the buyer's agent and the listing agent.",
          },
        ]}
        relatedCalculators={[
          {
            ...
            desc: "Calculate your product's selling price based on cost and markup.",
          },
          {
            name: "Margin Calculator",
            path: "/margin-calculator",
            desc: "Find your gross margin percentage and profit.",
          },
          {
            name: "Tip Calculator",
            path: "/tip-calculator",
            desc: "Easily split the bill and calculate gratuity percentages.",
          },
        ]}
      />
    </div>
