        ...
        <div className="max-w-4xl mx-auto p-4 md:p-8 bg-zinc-50 rounded-2xl shadow-xl border border-zinc-200">
            ...
            <div className="mt-8">
                <CalculatorSEO
                    ...
                    whatIsIt={
                        <>
                            <p>Our <strong>Dividend Yield Calculator</strong> measures exactly how much "cash flow" you receive for every dollar you invest in a specific stock. While stock prices constantly fluctuate up and down, a dividend is a hard, cash payment deposited directly into your brokerage account by the company, simply as a reward for owning their shares.</p>
                            <p>The <em>yield</em> is expressed as a percentage. It tells you exactly what your annual return on investment (ROI) will be from dividends alone, completely ignoring whether the stock price goes up or down. Income investors rely heavily on this metric to build portfolios that pay their living expenses.</p>
                        </>
                    }
                    formula={
                        <>
                            <p>To calculate the yield, you simply divide the company's total annual dividend payout by its current stock price.</p>
                            <div className="bg-zinc-100 p-4 rounded-lg font-mono text-center text-[15px] shadow-sm my-4 flex flex-col gap-2 border border-zinc-200 text-zinc-900">
                                <p><strong>Dividend Yield</strong> = (Annual Dividend / Stock Price) × 100</p>
                            </div>
                        </>
                    }
                    example={
                        <>
                            <p>Let's look at a classic blue-chip dividend stock. Assume the company pays a <strong>$2.50 annual dividend</strong> per share, and the stock is currently trading for exactly <strong>$50.00</strong>.</p>
                            <ul className="list-disc pl-6 space-y-2 mt-4 text-zinc-700">
                                <li><strong>Step 1 (The Math):</strong> $2.50 ÷ $50.00 = 0.05.</li>
                                <li><strong>Step 2 (Formatting):</strong> 0.05 × 100 = 5%.</li>
                                <li><strong>Result:</strong> The stock has a <strong>5.00% Dividend Yield</strong>.</li>
                                <li><strong>Meaning:</strong> If you buy $10,000 worth of this stock today, you are guaranteed roughly $500 in pure cash income this year, regardless of what the stock market does.</li>
                            </ul>
                        </>
                    }
                    useCases={
                        <ul className="list-disc pl-6 space-y-4 text-zinc-700">
                            <li><strong>Passive Income Planning:</strong> Calculating exactly how large your portfolio needs to be to generate enough dividend cash flow to completely cover your monthly rent or mortgage payment.</li>
                            <li><strong>Comparing Investments:</strong> Deciding whether to put $50,000 into a risky 6% yielding stock, or a perfectly safe 4.5% yielding high-yield savings account (HYSA).</li>
                            <li><strong>Evaluating "Yield Traps":</strong> A stock might have a massive 15% yield. However, if the stock price recently crashed from $100 down to $10, the mathematical yield temporarily spikes to 15% right before the company goes bankrupt and cuts the dividend entirely.</li>
                        </ul>
                    }
                    faqs={[
                        {
                            question: "What is a 'Good' Dividend Yield?",
                            answer: "Generally, a yield between 2% and 6% is considered healthy and sustainable. Anything below 2% is typical for massive tech companies (like Apple or Microsoft) that prefer to use their cash to grow the company rather than pay shareholders. Anything above 8% is highly risky and often unsustainable."
                        },
                        {
                            question: "How often are dividends paid?",
                            answer: "In the United States, the vast majority of companies pay dividends quarterly (every 3 months). If a company has a $4.00 annual dividend, you will receive a $1.00 cash deposit into your account four times a year."
                        },
                        {
                            question: "Why does the yield change every day?",
                            answer: "Because the stock price changes every day. If a company pays a fixed $5 annual dividend, and the stock price crashes from $100 to $50, the yield mathematically instantly skyrockets from 5% to 10%."
                        }
                    ]}
                    relatedCalculators={[
                        { name: "Investment Calculator", path: "/investment-calculator", desc: "Project the long-term compounding growth of your reinvested dividends." },
                        { name: "ROI Calculator", path: "/roi-calculator", desc: "Calculate your total return including both stock appreciation and dividends." },
                        { name: "Net Worth Calculator", path: "/net-worth-calculator", desc: "Track your total asset growth over time." }
                    ]}
                />
            </div>
        </div>
