            ...
            <div className="prose prose-blue prose-lg text-gray-700 max-w-none">
                ...
                <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 my-6">
                    ...
                    <p className="text-yellow-700 mt-2 text-sm">
                        <strong>Health Calculators:</strong> The health, fitness, and medical calculators provided on this site are for informational and educational purposes only. They are not intended as a substitute for professional medical advice, diagnosis, or treatment. Always seek the advice of your physician or other qualified health provider with any questions you may have regarding a medical condition.
                    </p>
                    <p className="text-yellow-700 mt-2 text-sm mb-0">
                        <strong>Financial Calculators:</strong> The financial calculators are provided for estimation and illustrative purposes only. They do not constitute financial, investment, or legal advice. Calculator All cannot guarantee the absolute accuracy of these tools or their applicability to your individual circumstances. We highly highly recommend consulting a qualified financial advisor before making any major financial decisions.
                    </p>
                </div>
                ...
                <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">8. Modifications to Terms of Service</h2>
                <p>
                    Calculator All may revise these terms of service for its website at any time without notice. By using this website you are agreeing to be bound by the then current version of these terms of service.
                </p>

                <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">9. Contact Information</h2>
                <p>
                    If you have any questions regarding our Terms of Service, please contact us at <a href="mailto:harshal.cloud.aws@gmail.com" className="text-blue-600 hover:underline">harshal.cloud.aws@gmail.com</a>.
                </p>
            </div>
        </div>
    );
