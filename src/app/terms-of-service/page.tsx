export const metadata = {
    ...
    description: 'Terms of Service for Calculators All',
};
    ...
    return (
        <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-sm my-8">
            ...
            <div className="prose prose-blue text-gray-700">
                ...
                <p>Permission is granted to temporarily use the materials (information or software) on Calculators All's website for personal, non-commercial transitory viewing only.</p>

                <h2 className="text-xl font-semibold mt-6 mb-2">3. Disclaimer</h2>
                <p>The materials on Calculators All's website are provided on an 'as is' basis. We make no warranties, expressed or implied, and hereby disclaim and negate all other warranties including, without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights.</p>
                ...
                <p>In no event shall Calculators All or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on our website.</p>
            </div>
        </div>
    );
}
