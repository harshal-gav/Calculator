        ...
        <div className="max-w-4xl mx-auto p-4 md:p-8 bg-zinc-50 rounded-2xl shadow-xl border border-zinc-200">
            ...
            <div className="mt-8">
                <CalculatorSEO
                    ...
                    whatIsIt={
                        <>
                            <p>A <strong>Pyramid Calculator</strong> is a 3D geometric tool designed to compute the volume, surface area, and complex interior slant heights of any right rectangular or square pyramid.</p>
                            <p>A right rectangular pyramid features a flat rectangle base (Length and Width) with four triangular sidewalls that converge upward to a single central singularity point called the apex. This is the exact geometric shape utilized to build the classical Great Pyramids of Giza.</p>
                        </>
                    }
                    formula={
                        <>
                            <p>Deriving the volume is simple enough, but assessing surface area requires utilizing the Pythagorean Theorem to find the exact heights of the slanted, angled triangular walls. Assuming Length (\(l\)), Width (\(w\)), and Height (\(h\)):</p>
                            <ul className="list-disc pl-6 space-y-3 mt-4 text-zinc-700">
                                <li><strong>Volume (\(V\)):</strong> <code>(l × w × h) / 3</code>. It is exactly one-third the volume of a cubic prism of the same dimensions.</li>
                                <li><strong>Slant Height (Length Side, \(s_l\)):</strong> <code>√(h² + (w/2)²)</code></li>
                                <li><strong>Slant Height (Width Side, \(s_w\)):</strong> <code>√(h² + (l/2)²)</code></li>
                                <li><strong>Total Surface Area:</strong> <code>(l × w) + (l × s_l) + (w × s_w)</code></li>
                            </ul>
                        </>
                    }
                    example={
                        <>
                            <p>Let's find the measurements for a custom decorative stone pyramid that has a <strong>Base of 10x10 inches</strong> (making it a square pyramid), and a total central <strong>vertical height of 15 inches</strong>.</p>
                            <ul className="list-none space-y-2 mt-4 font-mono text-sm bg-amber-50 p-4 rounded-xl border border-amber-200">
                                <li><strong>Step 1 (Volume):</strong> Base Area (10×10) = 100. Volume = (100 × 15) / 3 = 1,500 / 3 = <strong>500 cubic inches</strong></li>
                                <li><strong>Step 2 (Slant Height):</strong> Because length and width are equal (10), there is only one slant height. √(15² + 5²) = √(225 + 25) = √250 ≈ <strong>15.8114 inches</strong></li>
                                <li><strong>Step 3 (Lateral Sidewall Area):</strong> 4 identical walls. Total Lateral Area = 2 × 10 × 15.8114 = <strong>316.228 sq inches.</strong></li>
                                <li><strong>Step 4 (Total Surface Area):</strong> Base (100) + Lateral (316.228) = <strong>416.228 sq inches</strong></li>
                            </ul>
                        </>
                    }
                    useCases={
                        <ul className="list-disc pl-6 space-y-4 text-zinc-700">
                            <li><strong>Roof construction:</strong> Contractors framing standard "hip roofs" or installing dormers use these exact mathematical formulas to understand how much surface area of shingles and plywood to purchase.</li>
                            <li><strong>Packaging & Logistics:</strong> Industrial designers creating triangular-packaging geometries (like specialized tea bags or luxury perfume bottles) to maximize internal fluid volume while minimizing cardboard surface area costs.</li>
                            <li><strong>Tents & Architecture:</strong> Calculating the canvas yardage required to manufacture large pyramid-shaped camping tents or outdoor event pavilions based on the required peak headroom height.</li>
                        </ul>
                    }
                    faqs={[
                        {
                            question: "How do I calculate a Square Pyramid?",
                            answer: "A square pyramid is merely a rectangular pyramid where the 'Length' and the 'Width' are identical numbers. To run the calculation, just enter the same exact number into both the Length and Width inputs."
                        },
                        {
                            question: "Why is the Volume divided by 3?",
                            answer: "It is a fundamental principle of 3D geometry established by ancient mathematicians. If you have a rectangular box (a prism) and a pyramid with the exact same base and height, the pyramid will ALWAYS hold exactly 33.333% (one third) of the water or sand the box holds."
                        },
                        {
                            question: "What is the difference between Height and Slant Height?",
                            answer: "The standard 'Height' is entirely internal—it is an invisible plumb line dropped straight down from the very tip (apex) to the dead center of the floor base. The 'Slant Height' is the measurable physical length running down the outside face of the angled triangle walls. The Slant Height is always longer."
                        }
                    ]}
                    relatedCalculators={[
                        { name: "Prism Calculator", path: "/prism-calculator", desc: "Calculate internal volume properties for long geometric prisms." },
                        { name: "Cone Calculator", path: "/cone-calculator", desc: "Evaluate a shape similar to a pyramid, but with an entirely circular flat base." },
                        { name: "Rectangle Calculator", path: "/rectangle-calculator", desc: "Easily evaluate the flat base of your structural pyramid." }
                    ]}
                />
            </div>
        </div>
