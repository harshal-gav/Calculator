    ...
    <div className="max-w-4xl mx-auto p-4 md:p-8 bg-zinc-50 rounded-2xl shadow-xl border border-zinc-200">
      <div className="text-center mb-10">
        ...
        <p className="text-emerald-700 text-lg max-w-2xl mx-auto">
          Calculate the area, perimeter, side length, and radii of a regular
          hexagon.
        </p>
      </div>
        ...
        <div className="bg-emerald-950 rounded-2xl p-6 md:p-10 shadow-2xl relative overflow-hidden flex flex-col items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full z-10">
            <div className="bg-black/30 p-4 rounded-xl border border-white/10 flex justify-between items-center">
              <span className="text-zinc-400 text-sm font-bold uppercase tracking-wide">
                Side (a)
              </span>
            ...
            <div className="bg-black/30 p-4 rounded-xl border border-white/10 flex justify-between items-center">
              ...
              <span className="font-mono text-emerald-100 font-bold text-xl">
                {results.diagonalShort.toFixed(4)}
              </span>
            </div>
            <div className="bg-black/30 p-4 rounded-xl border border-white/10 flex justify-between items-center md:col-span-2">
              ...
              <span className="font-mono text-emerald-100 font-bold text-xl">
                {results.diagonalLong.toFixed(4)}
              </span>
            </div>
          </div>
        </div>
      ...
      <div className="mt-8">
        <CalculatorSEO
          ...
          whatIsIt={
            <>
              <p>
                A <strong>Hexagon Calculator</strong> is a specialized geometry
                tool used to find all the key metric properties of a regular
                hexagon instantly.
              </p>
              <p>
                By entering just a single known measurement—like the side
                length, area, perimeter, inradius (apothem), or circumradius—the
                calculator automatically computes every other geometric property
                of the six-sided shape. It's built specifically for{" "}
                <em>regular</em> hexagons, where all six sides and all six
                interior angles are perfectly equal to one another.
              </p>
            </>
          }
          formula={
          ...
          example={
            <>
              <p>
                Let’s calculate the properties of a regular hexagon with a{" "}
                <strong>Side Length (a) of 5 cm</strong>:
              </p>
              <ul className="list-none space-y-2 mt-4 font-mono text-sm bg-zinc-50 p-4 rounded-xl border border-zinc-200 shadow-inner">
                <li className="flex justify-between border-b border-zinc-200 pb-2">
                  <span>1. Perimeter:</span>{" "}
                  <span>
                    6 × 5 = <strong className="text-emerald-700">30 cm</strong>
                  </span>
                </li>
                <li className="flex justify-between border-b border-zinc-200 py-2">
                  <span>2. Area:</span>{" "}
                  <span>
                    (3√3 / 2) × 5² ≈{" "}
                    <strong className="text-emerald-700">64.9519 cm²</strong>
                  </span>
                </li>
                <li className="flex justify-between border-b border-zinc-200 py-2">
                  <span>3. Inradius (Apothem):</span>{" "}
                  <span>
                    (√3 / 2) × 5 ≈{" "}
                    <strong className="text-emerald-700">4.3301 cm</strong>
                  </span>
                </li>
                <li className="flex justify-between pt-2">
                  <span>4. Circumradius:</span>{" "}
                  <span>
                    Equal to a ={" "}
                    <strong className="text-emerald-700">5 cm</strong>
                  </span>
                </li>
              </ul>
            </>
          ...
          useCases={
            <ul className="list-disc pl-6 space-y-4">
              <li>
                <strong>Architecture & Tiling:</strong> Hexagrams tessellate
                perfectly (they interlock without gaps), making them ideal for
                floor tiling, honeycomb structures, and patio layouts.
              </li>
              <li>
                <strong>Manufacturing:</strong> Calculating the exact
                cross-sectional area and wrench clearances required for
                hexagonal nuts and bolts.
              </li>
              <li>
                <strong>Tabletop Gaming:</strong> Designing hex-grid maps for
                strategy games where exact cell area and distance between hex
                centers (the Apothem) must be known.
              </li>
            </ul>
          }
          faqs={[
            {
              question:
                "What is the difference between a long diagonal and short diagonal?",
              answer:
                "A regular hexagon has two types of diagonals. The Long Diagonal (D) connects opposite vertices and passes straight through the center (length = 2a). The Short Diagonal (d) connects two non-adjacent vertices, bypassing the center entirely (length = √3 × a).",
            },
            {
          ...
          relatedCalculators={[
            {
              ...
              desc: "Calculate properties of 8-sided regular polygons.",
            },
            {
              name: "Polygon Calculator",
              path: "/polygon-calculator",
              desc: "Calculate properties for an n-sided regular polygon.",
            },
            {
